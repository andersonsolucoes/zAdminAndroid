...
import br.com.unidosdacachorra.zadmin.loja.produto.fragmentos.EditarProdutoFragment;
 ...
 */
public class EditarProdutoActivity extends AbstractActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getSupportFragmentManager().beginTransaction().add(R.id.content, new EditarProdutoFragment()).commit();
